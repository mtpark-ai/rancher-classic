...
func (s *SchedulerTestSuite) TestPortReservation(c *check.C) {
	...
	data, err := scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: strconv.Itoa(id), ResourceUUID: "u" + strconv.Itoa(id), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.IsNil)
	...
	err = scheduler.ReleaseResources("1", []ResourceRequest{PortBindingResourceRequest{InstanceID: strconv.Itoa(id), ResourceUUID: "u" + strconv.Itoa(id), Resource: "portReservation", PortRequests: releaseSpec}})
	c.Assert(err, check.IsNil)
	id++
	...
	_, err = scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: strconv.Itoa(id), ResourceUUID: "u" + strconv.Itoa(id), Resource: "portReservation", PortRequests: specs}})
	...
	specs = []PortSpec{{IPAddress: "192.168.1.5", PublicPort: 8085, PrivatePort: 8085, Protocol: "tcp"}}
	_, err = scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: "2", ResourceUUID: "12346", Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.NotNil)
}
...
func (s *SchedulerTestSuite) TestPortReservationProtocol(c *check.C) {
	...
	data, err := scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: strconv.Itoa(id), ResourceUUID: strconv.Itoa(id), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.IsNil)
	...
	data, err = scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: "2", ResourceUUID: "u" + strconv.Itoa(id), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.IsNil)
	c.Assert(data["portReservation"].([]map[string]interface{})[0]["allocatedIPs"], check.HasLen, 2)
	id++
	...
	data, err = scheduler.ReserveResources("1", false, []ResourceRequest{PortBindingResourceRequest{InstanceID: "3", ResourceUUID: "u" + strconv.Itoa(id), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.NotNil)
	id++

	// release resource
	specs = []PortSpec{{PublicPort: 8081, PrivatePort: 8081, Protocol: "udp", IPAddress: "192.168.1.1"}}
	err = scheduler.ReleaseResources("1", []ResourceRequest{PortBindingResourceRequest{InstanceID: "2", ResourceUUID: "u" + strconv.Itoa(id-3), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.IsNil)
	id++
	...
	specs = []PortSpec{{PublicPort: 8083, PrivatePort: 8083, Protocol: "tcp", IPAddress: "192.168.1.10"}}
	err = scheduler.ReleaseResources("1", []ResourceRequest{PortBindingResourceRequest{InstanceID: strconv.Itoa(id - 1), ResourceUUID: "u" + strconv.Itoa(id-1), Resource: "portReservation", PortRequests: specs}})
	c.Assert(err, check.IsNil)
	id++
